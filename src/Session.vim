...
setlocal fen
silent! normal! zE
let s:l = 57 - ((14 * winheight(0) + 14) / 28)
...
setlocal fen
silent! normal! zE
let s:l = 55 - ((0 * winheight(0) + 14) / 29)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
55
...
setlocal fen
silent! normal! zE
let s:l = 48 - ((28 * winheight(0) + 29) / 58)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
48
...
setlocal fen
silent! normal! zE
let s:l = 167 - ((0 * winheight(0) + 29) / 58)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
167
...
setlocal fen
silent! normal! zE
let s:l = 209 - ((53 * winheight(0) + 29) / 58)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
209
