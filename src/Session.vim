...
set shortmess=aoO
badd +173 learn/gens.go
badd +219 main.go
badd +153 io/input.go
badd +105 io/output.go
...
badd +63 utils/cluster/dbscan.go
...
exe '4resize ' . ((&lines * 28 + 30) / 61)
exe 'vert 4resize ' . ((&columns * 118 + 119) / 239)
tabedit ~/go/src/github.com/RenatoGeh/gospn/src/utils/log.go
set splitbelow splitright
set nosplitbelow
set nosplitright
wincmd t
...
setlocal fen
silent! normal! zE
let s:l = 197 - ((25 * winheight(0) + 29) / 58)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
197
...
setlocal fen
silent! normal! zE
let s:l = 175 - ((4 * winheight(0) + 14) / 29)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
175
...
setlocal fen
silent! normal! zE
let s:l = 152 - ((26 * winheight(0) + 14) / 28)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
152
