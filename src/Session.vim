...
set shortmess=aoO
badd +7 learn/gens.go
badd +640 main.go
badd +153 io/input.go
badd +104 io/output.go
...
badd +18 utils/cluster/dbscan.go
...
setlocal fen
silent! normal! zE
let s:l = 66 - ((26 * winheight(0) + 14) / 28)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
66
...
setlocal fen
silent! normal! zE
let s:l = 153 - ((28 * winheight(0) + 29) / 58)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
153
...
setlocal fen
silent! normal! zE
let s:l = 154 - ((28 * winheight(0) + 29) / 58)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
154
...
setlocal fen
silent! normal! zE
let s:l = 215 - ((33 * winheight(0) + 29) / 58)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
215
...
setlocal fen
silent! normal! zE
let s:l = 214 - ((28 * winheight(0) + 14) / 29)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
214
...
setlocal fen
silent! normal! zE
let s:l = 18 - ((8 * winheight(0) + 14) / 28)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
18
