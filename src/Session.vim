...
setlocal fen
silent! normal! zE
let s:l = 196 - ((2 * winheight(0) + 29) / 58)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
196
...
setlocal fen
silent! normal! zE
let s:l = 349 - ((20 * winheight(0) + 14) / 29)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
349
...
setlocal fen
silent! normal! zE
let s:l = 364 - ((25 * winheight(0) + 29) / 58)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
364
...
setlocal fen
silent! normal! zE
let s:l = 90 - ((28 * winheight(0) + 29) / 58)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
90
...
setlocal fen
silent! normal! zE
let s:l = 107 - ((57 * winheight(0) + 29) / 58)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
107
