...
$\binom{n}{2}$. Substituting these values into the amortized complexity of our Union-Find
implementation gives
\begin{equation*}
  {(3n)}^2\log_2^*\binom{n}{2}=9n^2\log_2^*\left(\frac{n!}{(n-2)!2!}\right)=
    9n^2\log_2^*\left(\frac{n(n-1)}{2}\right)
\end{equation*}
Let $\alpha(n)=\log_2^*\left(\frac{n(n-1)}{2}\right)$. We know that $\alpha(n)$ grows extremely
slow, therefore we will assume $\alpha(n)$ as a constant, giving the final complexity of
\code{FindConnectedSubgraphs} the form $\bigo(n^2)$.
