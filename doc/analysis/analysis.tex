...
a pixel variable) and sufficiently big, the learning time remains fairly short whilst computing
each inference becomes even smaller. As we shall see from other datasets, such phenomena is not
present in larger, more complex sets.
...
\begin{figure}[h]
  ...
  correct labeling for each $p$. The errorbars on each $p$ value shows the minimum and maximum
